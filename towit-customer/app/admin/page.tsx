    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        <div className="max-w-md w-full text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Acceso Administrativo</h1>

          {isUnauthorized ? (
            <div className="bg-red-50 border-l-4 border-red-500 text-red-700 p-6 mb-8 text-left rounded shadow-sm">
            ...
            <>
              <p className="text-lg text-gray-700 mb-8">Ingresa con tus credenciales asignadas para acceder al panel de control.</p>
